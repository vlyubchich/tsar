...
The resampling step will give us 'new' cases of collected samples, while the statistics calculated multiple times will let us approximate the distribution of the parameter of interest in this case of violated distributional assumption.
