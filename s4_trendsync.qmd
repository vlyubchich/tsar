...
- a multi-model average of temperatures from the 5th phase of the Coupled Model Intercomparison Project (CMIP5),
...
Note the results differ quite a lot based on the window used for computing the WAVK statistic.
The function `funtimes::sync_test()` automatically selects the optimal window based on the heuristic approach of computing distances between bootstrap distributions [@Lyubchich:Gel:2016:synchronism;@Lyubchich:2016:trends].
:::
